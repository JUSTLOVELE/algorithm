...
workspace_dir = 'C://dataset//lhy_data//hw3_hw5_hw7_2_and_7_3//food-11'
print("Reading data")
...
"""# Dataset
在 PyTorch 中，我們可以利用 torch.utils.data 的 Dataset 及 DataLoader 來"包裝" data，使后续的 training 及 testing 更为方便。
